...
p7=plot(x,CH_eff_2D(x),'m-.s','LineWidth',1.5,'MarkerSize',7,'MarkerIndices',[round(5*M/30),round(11*M/30),round(17*M/30),round(23*M/30),round(29*M/30)]);
...
p8=plot(x,CH_eff_3D(x),'k-.d','LineWidth',1.5,'MarkerSize',7,'MarkerIndices',[round(5*M/30),round(11*M/30),round(17*M/30),round(23*M/30),round(29*M/30)]);
