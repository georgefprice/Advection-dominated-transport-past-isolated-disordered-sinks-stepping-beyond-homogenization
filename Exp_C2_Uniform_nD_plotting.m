...
% Plotting
p1=plot(x,C_mean, '-o', 'color', [0.8500, 0.3250, 0.0980], 'LineWidth', 1.5, 'MarkerSize', 7, 'MarkerIndices', [round(M/30),round(7*M/30),round(13*M/30),round(19*M/30),round(25*M/30)]);
...
p4=plot(x,CH(x)+(Da^2).*Exp_C2_simplified, ':o', 'color', [0.3010, 0.7450, 0.9330], 'LineWidth', 1.5, 'MarkerSize',7, 'MarkerIndices', [round((3*M-15)/30),round((9*M-15)/30),round((15*M-15)/30),round((21*M-15)/30),round((27*M-15)/30)]);
